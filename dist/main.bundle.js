...
var CreateStoryPageComponent = (function () {
    ...
    CreateStoryPageComponent.prototype.publishStory = function () {
        var _this = this;
...
var WriteNextPageComponent = (function () {
    ...
    WriteNextPageComponent.prototype.validateDescription = function (stepper) {
        stepper.next();
    };
    WriteNextPageComponent.prototype.validateParagraph = function (stepper) {
        stepper.next();
    };
    WriteNextPageComponent.prototype.publishStory = function () {
        var _this = this;
        var story = new __WEBPACK_IMPORTED_MODULE_2__story_service__["a" /* Story */]();
